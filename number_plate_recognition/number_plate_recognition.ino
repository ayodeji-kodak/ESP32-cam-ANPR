...
const char* ssid = "Ayo_EXT";                   // Replace xxx with your WiFi SSID
const char* password = "Capsam2005.";           // Replace xxx with your WiFi Password
...
String apiKey = "zV7nHx8sxZMU";                 // Replace xxx with your API key
...
void handleRoot() {
  ...
  html += "</head><body>";
  html += "<header><h1>Ayodeji Oyelakin</h1></header>";
